    ...
    *,
    ...
    card_lines = [
        ...
        *[f'- {line}' for line in _regenai_pt_architecture_summary(config_payload)],
        ...
        f"- de_loss_weight: {config_payload.get('de_loss_weight', 0.0)}",
        f"- delta_loss_weight: {config_payload.get('delta_loss_weight', 0.0)}",
        f"- delta_context_keys: {config_payload.get('delta_context_keys', [])}",
        ...
        f"- duration_regularization_weight: {config_payload.get('duration_regularization_weight', 'unknown')}",
        f"- component_duration_key: `{config_payload.get('component_duration_key', 'unknown')}`",
...
def train_and_register_regenai_pt_forward_transition(
    ...
    return train_and_register_regenai_pt(
        ...
        config_kwargs={
            ...
            'duration_regularization_weight': duration_regularization_weight,
